...
for i in range(len(hidden_neurons)):
    ...
    errors, nn, cost_train, cost_test = train(X_train_normalized, y_train, hidden_neurons[i], iterations, learning_rate, X_test_normalized, y_test, is_iris)
    ...
    plot_filename = os.path.join(os.getcwd(), 'figures\\irisExample', 'Iris_train_test_cost_neurons' + str(hidden_neurons[i]) +'.png')
    plt.savefig(plot_filename)
